...
class SpeedTestNotifier extends StateNotifier<SpeedTestState> {
  ...
  // Progress tracking
  static const int _totalMeasurements = 11; // Total measurements in our optimized sequence
  ...
  void _calculateFinalResults() {
    ...
    // PING: Minimum latency (best case RTT)
    final ping = _latencies.isNotEmpty ? _latencies.reduce((a, b) => a < b ? a : b) : 0;

    // LATENCY: Median latency (50th percentile - typical latency)
